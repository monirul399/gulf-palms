...
export default async function FarmDetails({
  ...
  const breadcrumbLinks = [
    ...
    {
      name: slug === "wafrah-farm" ? "Wafrah Farm" : "Abdali Farm",
      href: slug === "wafrah-farm" ? "/wafrah-farm" : "/abdali-farm",
    },
  ];
  const farm =
    slug === "wafrah-farm"
      ? {
          ...
          video:
            "https://gulfpalms.com/wp-content/uploads/2021/09/2-slide-img.jpg",
